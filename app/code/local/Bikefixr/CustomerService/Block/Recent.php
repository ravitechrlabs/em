<?php
class Bikefixr_CustomerService_Block_Recent extends Mage_Core_Block_Template
{
		...
		public function getOrders($ordnum)
		
		{
			$orders = Mage::getModel('customerservice/customerservice')->loadord($ordnum);
