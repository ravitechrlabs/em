...
class Ravi_Example_Block_Adminhtml_Example_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('example')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('example')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
